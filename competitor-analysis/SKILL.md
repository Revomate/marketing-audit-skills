...
1. **Competitor profiles** (3-5 competitors) covering SEO, paid ads, social media, email/lifecycle, and pricing
2. **Competitive matrix** with 8-12 dimensions compared across all players
3. **SWOT analysis** for each major competitor
4. **Positioning map** visualizing competitive differentiation
5. **Strategic recommendations** covering positioning, content, paid, product, pricing, and quick wins
6. **Competitive Landscape Summary** (downstream reference with competitor table, market map, white space identification)

This skill does NOT produce: Product specifications, design mockups, implementation timelines, or revised product roadmaps.
...
## Downstream Output Format

When competitor-analysis output feeds into `positioning-angles`, `content-strategy`, or `keyword-research`, include this standardized competitive landscape section at the end of the output. This ensures downstream skills can consume the analysis without re-interpreting raw data.

```markdown
## Competitive Landscape Summary (Downstream Reference)

### Competitor Table
| Competitor | Positioning Statement | Target Audience | Price Range | Primary Channel | Key Weakness |
|------------|----------------------|-----------------|-------------|-----------------|--------------|
| [Name] | [How they position themselves — in their own words] | [Who they target] | [$/mo or range] | [Where they acquire customers] | [Exploitable gap] |

### Market Map
Axes: [Dimension 1] vs [Dimension 2]
- [Competitor A]: [position on both axes]
- [Competitor B]: [position on both axes]
- [You / white space]: [where you sit or could sit]

### White Space Identification
- Underserved audience: [Who no competitor is serving well]
- Underserved need: [What problem no competitor solves adequately]
- Positioning gap: [What angle no competitor has claimed]
- Channel gap: [Where no competitor has presence]

### Competitive Proof Points
[Specific data points downstream skills can reference in copy, content, and positioning:]
- "[Competitor X] charges $Y but doesn't include [feature]"
- "[Competitor X] has [weakness] based on [evidence source]"
- "No competitor in this space offers [your differentiator]"
```

This section should be copy-paste ready for `positioning-angles` (white space + proof points), `content-strategy` (gap-driven topics), and `keyword-research` (competitor keyword gaps).

## Quality Checks

- [ ] Did you analyze at least 3 competitors across multiple dimensions (not just one)?
- [ ] Is each competitor's positioning clearly articulated — not just a list of features?
- [ ] Did you identify specific gaps and opportunities, not just describe what competitors do?
- [ ] Are data points sourced and verifiable (traffic estimates, pricing, feature lists)?
- [ ] Is the output structured so positioning-angles and other downstream skills can consume it directly?
- [ ] Did you avoid recency bias — considering established competitors, not just trending ones?
- [ ] Does the competitive landscape map show where whitespace exists for differentiation?
